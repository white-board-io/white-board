...
export async function updateTodoHandler(
  ...
  // ⚡ Bolt: removed findById to perform atomic update and existence check in one query
  // Input validation must happen before DB calls to prevent unnecessary overhead.
